...
public class MysqlGenerator2 {
    ...
    public static void main(String[] args) {
        ...
        pc.setModuleName("");
        pc.setParent("com.free.badmood.blackhole.web");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                String path = projectPath + "/" + moduleName +
        ...
        */
        ...
        strategy.setSuperEntityClass("com.free.badmood.blackhole.base.entity.BaseEntity");
        strategy.setEntityLombokModel(true);
        strategy.setRestControllerStyle(true);
        // 公共父类
        strategy.setSuperControllerClass("com.free.bodmood.blackhole.base.controller.BaseController");
        // 写于父类中的公共字段
        strategy.setSuperEntityColumns("id","createTime","updateTime","del");
